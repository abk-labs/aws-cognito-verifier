...
var userPoolId = 'ap-southeast-2_xxxxxxxxx';
var appClientId = '<ENTER APP CLIENT ID HERE>';
var keys_url = 'https://cognito-idp.' + ${region} + '.amazonaws.com/' + ${userPoolId} + '/.well-known/jwks.json';
